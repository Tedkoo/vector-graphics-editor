    ...
    class CreateFigureCommand : ICommand
    {
        ...
        public void MouseDown(MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {
                ...
                else if (_scene.currentShape == "Star")
                {
                    Star star = new Star();
                    star.Location = e.Location;
                    star.Side = 80;
                    star.Radius = 90;
                    star.BorderColor = _scene._currentColor;
                    star.InsideColor = _scene._currentColor;

                    _scene._shapes.Add(star);
                }
                    _scene.Invalidate();
            }
        }
